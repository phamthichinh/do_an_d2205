            ...
            for (int y = 0; y < board.height; y++)
            {
                ...
                if(currentGem != null)
                {
                    if(x > 0 && x < board.width - 1)
                    {
                        ...
                        {
                            if(leftGem.type == currentGem.type && rightGem.type == currentGem.type && currentGem.type != Gem.GemType.dice)
                            {
                    ...
                    if (y > 0 && y < board.height - 1)
                    {
                        ...
                        {
                            if (aboveGem.type == currentGem.type && belowGem.type == currentGem.type && currentGem.type != Gem.GemType.dice)
                            {
                                currentGem.isMatched = true;
